...
public class GetData {
	...
	public static Technology newTech() {
		...
		Technology newTech = new Technology(null, null, null, 0, null);

		try {
			newTech = new Technology(Utilities.getString("Set Technology name: "),
	...
	public static WebPage newWeb() {
		...
		WebPage newWeb = new WebPage(null, null, 0);

		try {
			newWeb = new WebPage(Utilities.getString("Introduce Webpage name: "),
	...
	public static String webField() {
		...
		try {
			columnNumber = Utilities.getIntBetween(1, 5,
					"Enter 1, 2, 3 or 4 to search a web by: id, name, url or budget.");
			switch (columnNumber) {
			case 1:
				chosenField = "webid";
				break;
